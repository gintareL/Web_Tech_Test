...
public class Models extends Observable{
	...
	public SortedMap<Integer, Uebung> uebungenListeMuskelgruppe(String muskelgruppe){
		...
		try {
			...
			String muskel1;
			String muskel2;
			//Muskel muskelgruppe = Muskel.valueOf("muskelgruppe");
			...
			while ( rs.next() ) {
				...
				System.out.println(alleUebungen.get(id).getId());
			}
			//  stmt.close();
	...
	/*	try {
			...
			String equipment;
			String grad;
			String muskelgruppe = null;
			String muskel1;
			String muskel2;
			String sql = "SELECT u.like, u.dislike, u.id, u.name, u.bild, u.muskel as muskelgruppe, b.equipment, b.grad, b.muskel, b.muskel2 FROM uebung u, beschreibung b  where u.id=? and b.id = u.beschreibung;"  ;
			PreparedStatement preparedStatement =conn.prepareStatement(sql);
			...
			while ( rs.next() ) {
				...
				equipment = rs.getString("equipment");
				grad = rs.getString("grad");
				muskelgruppe = rs.getString("muskelgruppe");
				muskel1 = rs.getString("muskel");
				muskel2 = rs.getString("muskel2");
				int id = rs.getInt("id");
				int like = rs.getInt("like");
				int dislike = rs.getInt("dislike");
				uebung = new Uebung(id, name, equipment, grad, muskel1, muskel2, bild, Muskel.valueOf(muskelgruppe), like, dislike);
